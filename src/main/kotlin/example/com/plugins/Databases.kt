...
fun Application.configureDatabases() {
    ...
    val cityController = CityController(dbConnection)
    ...
    routing {
        ...
        get("/cities") {
            ...
            val cities = cityController.getAllCities(page, perPage)
...
fun Application.connectToPostgres(embedded: Boolean): Connection {
    Class.forName(environment.config.property("postgres.driver").getString() ?: "org.postgresql.Driver")
    if (embedded) {
